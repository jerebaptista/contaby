...
function SidebarRail({
  ...
  const label =
    tooltipExpand != null && tooltipCollapse != null
      ? showExpand
        ? tooltipExpand
        : tooltipCollapse
      : "Toggle Sidebar"
